...
Стандартный RAG из туториала ломается на первом же реальном документе. Одно и то же лицо встречается в пяти формах: «ИП Иванова», «Иванова В.В.», «Иванова» — один арендатор или три? Векторный поиск не умеет отвечать «сколько платит Петров?» — он ищет похожий текст, а не точные цифры.
